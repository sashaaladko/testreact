    ...
    reducers: {
        ...
        cartPrice: (state, action) => {
            state.cartItems.map(e=>
                state.amount = state.cartItems.cartAmount*state.cartItems.length
            )
...
export const {addToCart, incrementAmount, decrementAmount, removeItem, cartPrice} = cartSlice.actions